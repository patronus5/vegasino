...
class FarmCard extends React.Component
{
	...
	{   
        ...
        console.log(props.refFarmModalManager)
		//init
		this.id = props.id
    ...
    renderUserDepositUSD()
    {
        return this.renderNameValueGroup(
            "userDepositUSD",
            "Deposit $:",
            LLib.renderLoading(
                this.farm.initializedUser && this.farm.depositToken.initializedPrice, 
                LWeb3.formatFiatDisplay(this.farm.userDepositUSD)),
            this.farm.initializedUser && this.farm.userDeposit === "0")
    }
        ...
        return this.renderNameValueGroup(
            ...
            LLib.renderLoading(
                ...
                LLib.smartFormatPercent(
                    this.farm.apr * 100, 
                    true)),
            this.farm.initializedInfo && this.farm.apr === 0)
    }
    ...
    renderCompound()
    {
        ...
        return (
            <Group className="compound">
                <Button buttonStyle={fiat > 0 ? 1 : 0} onClick={() => this.onClick_compound()}>
                    Compound
                </Button>
            </Group>
        )
    ...
    render()
    {
        let cn = "FarmCard " + (this.props.className || "")
        ...
        return (
			<Group className={cn}>
                ...
                {this.renderUserDepositUSD()}

                <Group className="claimDepositWithdraw">
